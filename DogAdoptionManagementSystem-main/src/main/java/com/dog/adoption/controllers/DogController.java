...
public class DogController {
    ...
    @GetMapping({"/staff_page/staff_manage_dogs",  "/admin_page/admin_manage_dogs"})
    ...
    @GetMapping({"/staff_page/staff_manage_dogs/add_dog", "/admin_page/admin_manage_dogs/add_dog"} )
    ...
    @PostMapping({"/staff_page/staff_manage_dogs/add_dog/submit-add", "/admin_page/admin_manage_dogs/add_dog/submit-add"})
    ...
    @GetMapping({"/staff_page/staff_manage_dogs/update_dog", "/admin_page/admin_manage_dogs/update_dog"} )
    ...
    @PostMapping({"/staff_page/staff_manage_dogs/update_dog/submit-update", "/admin_page/admin_manage_dogs/update_dog/submit-update"})
    public String postDogUpdatePage(@ModelAttribute Dog updatedDog, HttpSession session) {
        ...
        if (dog != null) {
            ...
            if (!ValidationUtils.isStringNullOrEmpty(dog.getAdoptionStatus())) {
                dog.setAdoptionStatus(updatedDog.getAdoptionStatus());
            }
            if (!ValidationUtils.isStringNullOrEmpty(dog.getImage())) {
