...
public class VolunteerController {
    ...
    @GetMapping({"/staff_page/staff_manage_volunteers","/admin_page/admin_manage_volunteers"})
    ...
    @GetMapping({"/staff_page/staff_manage_volunteers/staff_update_volunteer","/admin_page/admin_manage_volunteers/admin_update_volunteer"})
    ...
    @PostMapping({"/staff_page/staff_manage_volunteers/staff_update_volunteer","/admin_page/admin_manage_volunteers/admin_update_volunteer"})
    ...
    @GetMapping({"/staff_page/staff_manage_volunteers/staff_add_volunteer","/admin_page/admin_manage_volunteers/admin_add_volunteer"})
    ...
    @PostMapping({"/staff_page/staff_manage_volunteers/staff_add_volunteer","/admin_page/admin_manage_volunteers/admin_add_volunteer"})
