...
public class VaccineController {
    ...
    @GetMapping({"/staff_page/staff_manage_vaccines", "/admin_page/admin_manage_vaccines"})
    ...
    @PostMapping({"/staff_page/staff_manage_vaccines/add_vaccine","/admin_page/admin_manage_vaccines/add_vaccine"})
