...
public class UserController {
    ...
    @GetMapping("/staff_page/staff_my_profile")
    ...
    @PostMapping("/staff_page/staff_my_profile/update-profile")
    public String postStaffUpdatePage(@ModelAttribute User updatedUser, HttpSession session) {
        ...
        if (user != null) {
            ...
            if (!ValidationUtils.isStringNullOrEmpty(updatedUser.getUsername())) {
        ...
        return "redirect:/staff_page/staff_my_profile";
    }
    ...
    @GetMapping({"/admin_page/admin_manage_staff","/admin_page/admin_manage_user", "/admin_page/admin_manage_admin"})
    ...
    @GetMapping({"/admin_page/admin_manage_staff/admin_add", "/admin_page/admin_manage_user/admin_add", "/admin_page/admin_manage_admin/admin_add"})
    ...
    @PostMapping({"/admin_page/admin_manage_staff/admin_add/submit-add-staff","/admin_page/admin_manage_user/admin_add/submit-add-user","/admin_page/admin_manage_admin/admin_add/submit-add-admin"})
    public String postAdminAddPage(@ModelAttribute UserData request, @RequestParam String confirmPassword, Model model, HttpSession session,@RequestParam(name = "type", defaultValue = "") String type){
        try {
            ...
            if(type.equals("submitStaff")) {
                ...
                return "redirect:/admin_page/admin_manage_staff?type=manageStaff";
            }
                ...
                return "redirect:/admin_page/admin_manage_user?type=manageUser";
            }
                ...
                return "redirect:/admin_page/admin_manage_admin?type=manageAdmin";
            }
            return "error";
        } catch (RuntimeException e) {
            model.addAttribute("error", e.getMessage());
            model.addAttribute("registerRequest", request);
            if(type.equals("submitStaff")) {
                return "redirect:/admin_page/admin_manage_staff/admin_add?type=manageStaff";
            }
            else if (type.equals("submitUser")){
                return "redirect:/admin_page/admin_manage_user/admin_add?type=manageUser";
            }
            else if (type.equals("submitAdmin")){
                return "redirect:/admin_page/admin_manage_admin/admin_add?type=manageAdmin";
            }
            return "error";
        }
    }

    @GetMapping({"/admin_page/admin_manage_staff/admin_update","/admin_page/admin_manage_user/admin_update", "/admin_page/admin_manage_admin/admin_update"})
    ...
    @PostMapping({"/admin_page/admin_manage_staff/admin_update/update-profile", "/admin_page/admin_manage_user/admin_update/update-profile", "/admin_page/admin_manage_admin/admin_update/update-profile"})
    ...
    @GetMapping({"/admin_page/admin_manage_staff/admin_delete", "/admin_page/admin_manage_user/admin_delete", "/admin_page/admin_manage_admin/admin_delete"})
